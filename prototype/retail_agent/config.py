...
resolved here once, into an immutable ``Settings`` object.
"""
...
# Directory holding seed data + generated runtime state (sqlite, caches).
...
class Settings:
    ...
    def sqlite_path(self) -> Path:
        return self.data_dir / "retail_agent.sqlite"
    ...
    @property
    def trios_path(self) -> Path:
        return self.data_dir / "golden_trios.json"
...
def get_settings(user_id: str | None = None) -> Settings:
    ...
    return Settings(
        ...
        model_run_limit=_env_int("MODEL_RUN_LIMIT", 8),
        data_dir=_DATA_DIR,
    )
